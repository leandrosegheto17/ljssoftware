...
| G-15 | **[Revisada 2026-09-18, RA-10/RN-05]** Todo app publicado, web ou desktop, roteia o card da vitrine (`apps.html`)/prévia (`index.html`) para a página interna `[slug].html`; a URL externa do app vive só no CTA "Abrir app" dentro dessa página; nunca link direto para binário ou arquivo de download (o CTA de download de app desktop também fica só na página) | PRD-TECNICO.md RN-03 / SDD.md Seção 5 (modelo de dados, campo `tipo`) | Contraria requisito de produto confirmado pelo stakeholder; corrigir trocando o `href` do badge/link para a página própria, nunca para o arquivo |
